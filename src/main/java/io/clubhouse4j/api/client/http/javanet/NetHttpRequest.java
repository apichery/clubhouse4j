...
/**
 * Copy of {@link com.google.api.client.http.javanet.NetHttpRequest}, changed to authorize DELETE requests with payloads
 */
    ...
    public LowLevelHttpResponse execute() throws IOException {
        ...
        if (getStreamingContent() != null) {
            ...
            if ("POST".equals(requestMethod) || "PUT".equals(requestMethod)
                    ...
                    /*  CHANGE BEGIN HERE                        */
                    /* ----------------------------------------- */
                    || ("DELETE".equals(requestMethod) && contentLength > 0)
                    /* ----------------------------------------- */
                    /*  CHANGE END HERE                          */
                    /* ----------------------------------------- */
                    ) {
